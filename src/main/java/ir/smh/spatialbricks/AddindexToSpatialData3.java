...
public class AddindexToSpatialData3  implements Serializable {

    private final SparkSession spark;

    public AddindexToSpatialData3(SparkSession spark) {
        this.spark = spark;
    }
    ...
    public void AddOrUpdateIndex(TableSpec silver, String xColumnName, String yColumnName)
        ...
        String indexTableName = mainTableName + "_index";
        ...
        // -----------------------------
        // finding indexed and not indexed rows
        // -----------------------------

        Dataset<Row> notIndexedRows = spark.emptyDataFrame();

        Dataset<Row> newIndexEntries = mainTable.filter(col("partitionnumber").equalTo(-1));
